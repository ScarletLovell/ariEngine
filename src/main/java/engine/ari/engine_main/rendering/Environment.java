...
public class Environment {
    ...
    public static void makeNewEnvironment(float[] rgba, float[] dirRGB, float[] dir) {
        ...
        env.add(light.set(dirRGB[0], dirRGB[1], dirRGB[2], dir[0], dir[1], dir[2]));
    }
    public static void makeNewDefaultEnvironment() {
        env.set(new ColorAttribute(ColorAttribute.AmbientLight, 0.4f, 0.4f, 0.4f, 1f));
        env.add(light.set(0.8f, 0.8f, 0.8f, -1f, -0.8f, -0.2f));
    }
